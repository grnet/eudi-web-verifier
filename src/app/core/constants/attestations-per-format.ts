...
import {AGE_OVER_18_ATTESTATION, ALLIANCE_ID_ATTESTATION, EDUCATIONAL_ID_ATTESTATION, MDL_ATTESTATION, MY_ACADEMIC_ID_ATTESTATION, PHOTO_ID_ATTESTATION, PID_ATTESTATION} from "@core/constants/attestation-definitions";
...
export const MY_ACADEMIC_ID_MSO_MDOC: MsoMdocAttestation = {
  ...
  attributePath: (attribute: DataElement) => { return msoMdocAttributePath(attribute, 'eu.europa.ec.eudi.my_academic_id.1') }
}
...
export const ATTESTATIONS_BY_FORMAT: { [id: string]: Attestation[] } = {
  "mso_mdoc": [PID_MSO_MDOC, MDL_MSO_MDOC, PHOTO_ID_MSO_MDOC, AGE_OVER_18_MSO_MDOC, EDUCATIONAL_ID_MSO_MDOC, ALLIANCE_ID_MSO_MDOC, MY_ACADEMIC_ID_MSO_MDOC],
